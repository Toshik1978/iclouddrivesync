...
def main(args=None):
    ...
    parser.add_argument(
        ...
        dest="folder",
        default=None,
        help="Root folder to download from the iCloud Drive",
    )
    parser.add_argument(
        "-d",
        "--destination",
    ...
    try:
        if command_line.folder is not None:
            sync_folder(api.drive[command_line.folder], command_line.destination, api.drive[command_line.folder].dir(), False)
        else:
